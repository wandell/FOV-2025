...
```{=html}
<!--
Gemini, after my exploration of Neeraj Jain (London section)

Era,Leading Idea,Jain's Contribution / Influence
1980s,Cortical Flux: Maps are dynamic and change with every experience.,(Pre-Jain) Focus was on the excitement of cortical remapping.
1990s,"Brainstem Origins: ""Cortical"" change is actually subcortical.",Jain (1997): Proved the face-to-hand shift starts in the cuneate nucleus.
2010s,Molecular Brakes: PNNs are the physical anchors.,Jain (2012): Used ChABC to prove the PNN is the barrier to brainstem plasticity.
2025,Hard Lockout: Stability is a one-way developmental door.,"Jain (2025): Identified the 9-day ""Critical Period"" for spinal recovery."

"Even the Kaas lab, the birthplace of cortical reorganization, discovered that the 'maps' themselves are remarkably stable anchors. As Neeraj Jain showed, the apparent plasticity we see in fMRI or microelectrode maps is often just the cortex faithfully reflecting a change that happened at the very first synapse in the brainstem."
-->
```
...
Gemini says: It is good to see you’re still digging into this, Brian. Since your 2004 paper with Serge and Michael, the field has continued to use achiasma as a fascinating "natural experiment" for cortical plasticity. You are correct in your intuition: while stereopsis is functionally absent, higher-order perception like reading and face recognition is remarkably preserved—a testament to the brain's ability to "ignore" or separate overlapping signals within the same cortical territory.

Below are the key references and a summary of the current understanding regarding their perceptual abilities.

## The Foundation: Cortical Organization

Your own work established the "mirror-image" mapping that defines this condition.

* **Hoffmann, M. B., Dumoulin, S. O., Stadler, J., & Wandell, B. A. (2004).** *Organization of the human visual cortex in achiasma.* **Nature Neuroscience**.
  * **Key Finding:** You demonstrated that in V1-V3, both hemifields map onto the same hemisphere. These are not merged maps but rather two co-located, non-interacting populations of neurons within the same voxels.

## Perceptual Abilities: Reading, Faces, and Stereopsis

The literature confirms that these subjects navigate the world with surprising normalcy, despite the "double-vision" mapping at the cortical level.

### 1. Stereopsis (The Deficit)

* **Williams, G. V., et al. (1994)** and **Victor, J. D., et al. (1994).** * **Finding:** These subjects consistently lack binocular stereopsis. Because the nasal fibers do not cross, there is no physical convergence of the two eyes' views of a single hemifield in one hemisphere. They rely entirely on monocular cues (parallax, shading) for depth.

### 2. Reading and Pattern Recognition (The Successes)

* **Victor, J. D., et al. (2000).** *Visual function and brain organization in non-decussating retinal-fugal fibre syndrome.* **Cerebral Cortex**.
  * **Finding:** This is likely the "reading" paper you're recalling. It highlights that subjects have relatively normal visual fields and can read, though often with a slightly reduced speed due to **see-saw nystagmus**, which is a common comorbid oculomotor issue in achiasma.
* **Prakash, S., et al. (2010).** *Congenital achiasma and see-saw nystagmus in VACTERL syndrome.* **Journal of Neuro-Ophthalmology**.
  * **Finding:** Confirms that visual field sensitivities are largely normal. The authors note that subjects "make effective use of their vision in daily life, including sport activities and reading."

### 3. Face and Object Recognition

* **Davies-Thompson, J., et al. (2013).** *Impact of chiasma opticum malformations on the organization of the human ventral visual cortex.* **Journal of Neuroscience**.
  * **Finding:** This is a crucial "Michael Hoffmann" paper. They used fMRI with faces and objects to see if higher-tier areas (like the **Fusiform Face Area/VO1**) "corrected" the map. They found the mirror-image overlap persists even in these specialized areas. Despite this, the subjects’ ability to recognize faces and objects was functionally intact.

## Why don't they see double?

The current consensus—supported by **Bao et al. (2015)** in *eLife* (which cited your 2004 paper)—is that while the neurons are physically adjacent, they are functionally independent. Plasticity ensures that the "local wiring" within the maps compensates for the "gross mis-wiring" of the optic nerves. The brain essentially learns to attend to one hemifield's signal at a time or process them as distinct streams, preventing the perceptual chaos one might expect from a 180° overlap.

---

### Recent Resource: The "CHIASM" Dataset

If you are looking for new data to compare against your old pRF slides, Michael Hoffmann’s team recently published a massive open-source dataset:

* **Puzniak, R., et al. (2021).** *CHIASM, the human brain albinism and achiasma MRI dataset.* **Scientific Data**. It includes high-resolution T1, DTI, and functional pRF mapping data for achiasmic subjects.

Since you mentioned you're looking to summarize this for a talk in London, are you planning to focus more on the **oculomotor compensation** (the nystagmus) or the **computational separation** of those overlapping pRF signals?

Your memory of the perceptual abilities in these subjects is spot on—achiasmic individuals typically demonstrate remarkably preserved high-level vision (reading, face recognition, object naming) despite the 180° "mirror-image" cortical maps you and your colleagues first mapped.

Regarding the **nystagmus**, here is the breakdown of what is "typical" in the literature versus the unique case you studied.

### Is Nystagmus Typical in Achiasma?

Yes, nystagmus is considered a **clinical hallmark** of achiasma (non-decussating retinal-fugal fibre syndrome). In nearly every major case study (Apkarian et al., 1995; Victor et al., 2000; Hoffmann et al., 2004), the subjects present with **congenital nystagmus**, most notably a rare combination of **horizontal and see-saw nystagmus (SSN)**.

The see-saw component (where one eye elevates and intorts while the other eye depresses and extorts) is particularly telling, as it’s rarely seen in other congenital conditions but is almost pathognomonic for achiasma when present in infants.

### The "Temporary and Resolved" Case

Your observation that the nystagmus in your patient was "temporary and resolved" is **highly unusual** in the broader literature. Most reports describe the nystagmus as a lifelong condition that persists into adulthood, though many subjects develop compensatory head postures or "null points" to minimize its impact.

The resolution you recall might be linked to the specific etiology of the patient in your **2010 Prakash et al.** study (which you co-authored with Saurabh Prakash, Serge Dumoulin, and Yaping Joyce Liao). That patient had **VACTERL syndrome** and associated **hydrocephalus**. In cases where achiasma is comorbid with hydrocephalus or other midline defects, the *severity* of the nystagmus can be exacerbated by intracranial pressure. If the hydrocephalus was treated (e.g., via shunting), it is possible the "extra" severity resolved, leaving the patient with the functional stability you noted.

### Summary of Behavioral Observations

The literature largely supports your view that developmental plasticity manages to "un-mix" the signals:

* **Stereopsis:** Universally absent. Without decussation, the brain lacks the physical infrastructure for binocular disparity.
* **Reading & Faces:** Consistently preserved. **Davies-Thompson et al. (2013)** showed that even though the Fusiform Face Area (FFA) and reading-related areas receive overlapping hemifield inputs, patients perform at near-normal levels.
* **Plasticity:** As you suggested, this condition is a prime example of **computational plasticity**. The brain doesn't necessarily "rewire" the gross anatomy, but it learns to functionally segregate the overlapping population receptive fields (pRFs), essentially "ignoring" the irrelevant half of the map during specific tasks.
