...
Initially, Steve Engel and I along with many others developed a technique to measure eccentricity and angle maps using rings and wedges.  If you look at the video casually, you will see the wave from the occipital pole traveling in the anterior direction of the main map.  If you look a little more closely, you will also see a secondary ripple on the ventral occippital-temporal surface. That ripple starts when the stimulus is in the fovea and then fades out as the ring expands about half way (10 deg). The VOT eccentricity map is a second eccentricity map, confined mainly to the perifoveal visual field, that is distinct from the calcarine map.  

![Eccentricity mapping using an expanding ring stimulus (20 deg) in the calcarine and ventral occipital region](../../chapters/videos/eccentricity-map-encyclopedia.mp4){#eccentricity-ring width="80%" loop="true" autoplay="true" muted="true"}

We also made measurements using a rotating wedge stimulus to identify the angular representation. 
