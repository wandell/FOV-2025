...
Even as he first localized the human visual cortex, Henschen wondered whether visual experience might have an impact on the size (surface area) of the visual cortex representation [@henschen1893-visual-center]. He reported that the size of visual cortex was smaller in blind people, but at that time very little was known about the size variation in the population. The variation is quite large, about a factor of 2.5, which has been confirmed by a number of modern authors [@stensaas1974-v1-area; @dougherty2003-map-sizes; @benson2022-surface-area].  Thus, finding a smaller V1 in a blind person than a control sighted person is not definitive proof of an experience-dependent plasticity.

There was little expectation of adult cortical plasticity during the 1900s, with most scientists accepting the premise of a critical developmental period that would close at the age of about 8 years old in human.  Then, a series of papers appeared from leading groups in the US reported signifcant adult cortical plasticity, in both visual and somatosensory cortex[@gilbert1992-rf-dynamics; @kaas1990-adult-plasticity-visual;@recanzone1992-adult-plasticity-somatosensory;@jenkins1990-adult-plasticity-somatosensory].
