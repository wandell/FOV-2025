...
* Should I open up by mentioning the ISETBio project?
* Try making a revised Felleman and Van Essen figure that segregates maps from 'areas', shows clusters, reflects human, and includes multiple specializations for 'face', color and perhaps other categories.
* Make a figure that shows the many different types of visual stability measurements for rod monochromats, AMD, RP, Michael May, and maybe others.  Put the Tessa Dekker hierarchical paper in context for connectivity maps
