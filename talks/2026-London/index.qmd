...
![Eccentricity map emphasizing the central 3 deg.  This shows the two different eccentricity maps, one in calcarine and a second on the VOT.  Data from @brewer2005-visualFieldMaps-clusters.](images/Slide26.png){#fig-angle-map width="80%"}

More clusters.  Slides need reworking.
