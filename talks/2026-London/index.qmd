...
Cajal wrote this only after spending years trying to find evidence of axonal regeneration in the adult brain and spinal cord. His efforts were only met with failure.

There is no doubt from conception and through infance the brain undergoes a massive amount of change, developing in size and myelination or only the two most obvious and easiest to observe changes. There is also no doubt that the brain can adjust its function to a significant extent when there is some disruptions in the developmental program. There are many examples in the literature, but a particularly interesting case for the visual system is the disruption of how the retinal axons find their way to the lateral geniculate. 
...
Tell people in a short and comopelling way how the questions of two eyes versus one eyes, the timing, and all the other stuff we raised in the review paper have nevere been answered.  Not in anaimals.  Not in humans.
...
>In adults [20], the deafferented cortical foveal representation in rod achromatopsia is not silent, but driven by parafoveal input [25]. In essence, the visual field maps are preserved, but only represent retina covered with functional photoreceptors, that is rods."

Twety years on, the matter was taken up again by Baseler and colleagues, using much better screening method [@molz2023-achromatopsiavisualCortexStability2023].
...
@baseler2011-LargescaleRemappingVisual
@masuda2021-maculardepgeneration 
@masuda2008-maculardegenerationV1 
@rosenau2008-feedback
### Retinitis pigmentosa

References
@barsingerhorn2018-symbol 
@saber2015-saccade 
@masuda2010-retinitispigmentosa 
