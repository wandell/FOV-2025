...
![Comparative anatomy of the cluster surface areas (@meyer2025-clusters-evolution)](images/meyer2025-comparative.png){#fig-comparative width="80%"}
...
Three clear differences 
* Human visual cortex contains a much larger number of neurons and surface area, even though the human optic nerve contains fewer axons
* Relative to the surface area of V1, human V3 is much larger than macaque V3
...
![Meyer comparative anatomy @meyer2025-clusters-evolution](images/meyer2025-comparative.png){#fig-meyer-comparative width="80%"}
