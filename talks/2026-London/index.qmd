...
> But he did two things of permanent value. He was the first to distinguish in these vivisections between sensorial andpsychic blindness, and to describe the phenomenon of restitution of the visual function after its first impairment byan operation ; and the first to notice the hemiopic characterof the visual disturbances which result when only onehemisphere is injured. Sensorial blindness is absoluteinsensibility to light ; psychic blindness is inability to recognize the meaning of the optical impressions, as when we see a page of Chinese print but it suggests nothing to us.A hemiopic disturbance of vision is one in which neitherretina is affected in its totality, but in which, for example,the left portion of each retina is blind, so that the animalsees nothing situated in space towards its right (Page 41 in the downloaded PDF from mpg.de).

:::

The discovery that visual cortex contained multiple retinotopic maps in some animal model systems first came from the Wisconsin group and then Hubel and Wiesel (for a review of this history see @wandell2011-ImagingRetinotopicMaps). This was followed by a large collection of studies, summarized in Zeki's book, revealing multiple distinct anatomical and functional regions in macaque that came to be known as 'visual areas' @zeki1993-book. How to define a visual area has been challenged repeatedly (@wandell2007-VisualFieldMaps, @hayden2025-rethinking-areas), and at this point in time there seems to be good reason to clarify when we are describing a retinotopic map or a region identified by another criterion such as cellular properties or functional responses or connectivity.
...
But even as late as 1991, Horton and Hoyt  observed that there was no proof of multiple maps in human visual cortex.   @horton1991-quadraticdefects @horton1991-representationvisualfield
