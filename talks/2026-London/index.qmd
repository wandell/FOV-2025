...
![Nineteenth century neuroscientists, neurologists and opthalmologists who discovered the localization of visual signals in animal models (Ferrier, Munk) and the presence of a retinotopic map in human visual cortex (Henschen, Holmes, Inouye).](images/01-ferrier-munk-holmes.png){#fig-ferrier-munk-inouye-holmes width="80%"} 
...
![A: Ferrier's location of visual cortex in the angular gyrus](images/Slide5.png){#ferrier-angular-gyrus width="80%"}

![B: Munk's location of visual cortex in the occipital lobe](images/Slide6.png){#munk-occipital-lobe width="80%"}
:::
...
![Henschen's findings on the upper and lower field representations.](images/Slide9.png){#fig-henschence width="80%"}

His work was confirmed and extended by two clinicians working at opposite ends of the world - Holmes and Inouye - who studied the visual field loss from soldiers injured in the wars in Europe and Japan, respectively.

::: {#fig-inouye-holmes}

![A: Inouye](images/Slide11.png){#inouye-map width="80%"}

![B: Holmes](images/Slide12.png){#holmes-map width="80%"}
:::
...
![Felleman and Van Essen's hierarchical representation of areas in visual cortex.](images/01-felleman-vanessen.png){#fig-felleman-vanessen width="80%"}
...
::: column-margin
<!-- ![Draft Figure Title](images/draft-fig1.png){#fig-draft-1 width="80%"} -->
