...
- **The 1940s (V2 in cats and rabbits)**: The discovery of multiple visual field maps began when electrophysiological measurements revealed a second visual map (V2) adjacent to the primary visual cortex (V1) in the rabbit and cat. These early discoveries were spearheaded by Talbot, Marshall, Thompson, and a major laboratory group in Wisconsin led by Woolsey.
- **The 1960s (V2 and V3 in monkeys and cats)**: Mapping efforts successfully extended to non-human primates when Cowey identified a second map in the squirrel monkey in 1964. The following year, Hubel and Wiesel described a third map (V3) in the cat.
- **The 1970s–1990s (V4, MT/V5, and beyond)**: During this period, investigators focused heavily on parcellating the extrastriate cortex of non-human primates, causing the number of identified maps to grow rapidly. A major breakthrough was the discovery of V4 and the motion-sensitive MT/V5 maps in the owl monkey by Allman and Kaas in 1971. Around the same time, Semir Zeki conducted pioneering anatomical and single-unit studies that established a framework for the concentric organization of these maps in macaques.
- **Methodological challenges**: Identifying these early maps relied heavily on single-unit electrophysiology. Because the field of view for these technologies is so small, establishing the existence of a map was a notoriously difficult process that Hubel and Wiesel famously likened to "a dismaying exercise in tedium, like trying to cut the back lawn with a pair of nail scissors".
:::
