...
![Eccentricity map shows the most effective visual eccentricity (deg) for each location.](images/Slide23.png){#fig-eccentricity-map width="80%"}

![Angle map shows the most effective wedge angle for each location.](images/Slide24.png){#fig-angle-map width="80%"}

![V1-V3 shown on calcarine along with an eccentricity map emphasizing the cortical magnification.](images/Slide25.png){#fig-areas-magnification width="80%"}

Caption for all three.  Get the Benson-Winawer surface area paper in here, too.
...
And here they are shown on the flattened cortical surface, first the raw data and then with the cartoon overlay to emphasize the pattern.
...
This pattern of cortical retinotopic map clusters has been independently confirmed in both human and non-human primates, including [@kolster2009-clusters; @kolster2014-macaque-mt; @barton2017-sts-cluster; @mackey2017-clusters; @meyer2025-clusters-evolution] and also in pulvinar @arcaro2015-pulvinar-cluster.  The cluster architecture seems to be a basic principle and its explanation may be related to other principles, such as local computational processing and differential development and plasticity.

Arguing for a non-hierarchical view
...
Primate and Evolutionary Comparisons
Evolutionary Conservation (Meyer et al., 2025)
...
Most scientists believed that the retinotopic maps and 'visual areas' found in non-human primates would be a good model for human visual cortex.

```{=html}
<!--

Meyer/Arcaro 2025 PNAS paper shows the expansion of maps and in particular V3 quite well.
