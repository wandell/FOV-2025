...
Ferrier and Munk did their work in animal models.  It is important to mention the work of the Swedish neurologist, Henschen, who carefully observed the visual loss in human patients with occipital lesions. He concluded that at least part of the visual field, the upper and lower portions, were represented in cortex in an orderly map with the lower visual field in the dorsal occipital lobe and upper visual field in the ventral occipital lobe. 

![Henschen's findings on the upper and lower field representations.](images/henschen.png){#fig-henschen width="80%"}

Henschen's observations were confirmed and extended by two clinicians, people working at opposite ends of the world: Gordon Holmes and Tatsuye Inouye.  Both were studying the visual field loss from soldiers injured in their countries' wars, Holmes in Europe and Inouye in Japan.  In that era, the guns were not always lethal, and the helmets would permit bullets to enter and exit the posterior skull, effectively lesioning a portion of occipital cortex.  Such lesions could cause a permanent but partial visual field loss.  The visual field maps these clinicians produced were used as training material for decades.
...
## Multiple maps
Talbot and colleagues in Wisconsin were the first to discover that visual cortex includes multiple retinotopic maps (in rabbit in their case). Subsequently, Cowey observed the presence of a second visual map in a non-human primate [@cowey1964-v2]; Hubel and Wiesel reported two extrastriate maps in cat [@hubel1965-cat-v2-v3]. This was followed by a large collection of studies, summarized with some passion and attention to history by @zeki1993-book. Much of that work, and the many papers that followed, was concerned with revealing distinct anatomical regions that came to be known as 'visual areas'. Jon Winawer and I also reviewed this history in [@wandell2011-ImagingRetinotopicMaps]. Everyone should enjoy a visit with Charlie Gross' book that is filled with interesting histories of neuroscience discovery, and he includes more information about the Ferrier-Munk (and Schaefer) exchanges [@gross1998-brain-book].
